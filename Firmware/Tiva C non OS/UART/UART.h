...
extern void UART_C1101_Read(uint8_t * buf, uint16_t len);
extern void CC1101_Init(void);
extern void UART_C1101_Write(uint8_t* c_Buff, uint16_t ui16_len);
extern void UART_C1101_WriteCMD(uint8_t* c_Buff);
